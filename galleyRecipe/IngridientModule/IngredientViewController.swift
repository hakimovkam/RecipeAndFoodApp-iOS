...
<<<<<<<< HEAD:galleyRecipe/IngridientModule/View/IngredientViewController.swift
...
>>>>>>>> a1204a1 (Routing from FavoriteViewController and TimerListViewController to the following screens has been created.):galleyRecipe/IngridientModule/IngredientViewController.swift
