...
extension CountryCollectionView: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = dequeueReusableCell(withReuseIdentifier: ChipsCollectionViewCell.identidierCountry, for: indexPath) as? ChipsCollectionViewCell else { return UICollectionViewCell() }
